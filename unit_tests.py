...
grapl_filename = 'bareinboim_2020.grapl'
G = grapl_obj.readgrapl(open(grapl_filename, 'r').read())
assert G.isayclic()
...
grapl_filename = 'richardson_2017.grapl'
G = grapl_obj.readgrapl(open(grapl_filename, 'r').read())
...
grapl_filename = 'shpitser_thesis1.grapl'
G = grapl_obj.readgrapl(open(grapl_filename, 'r').read())
...
grapl_filename = 'shpitser_thesis2.grapl'
G = grapl_obj.readgrapl(open(grapl_filename, 'r').read())
...
grapl_filename = 'non_identify1.grapl'
G = grapl_obj.readgrapl(open(grapl_filename, 'r').read())
id_expr, expr, isident = algs.idfixing(G, {'X'}, {'Y'})
assert not G.isdag()
assert G.isayclic()
...
grapl_filename = 'non_identify2.grapl'
G = grapl_obj.readgrapl(open(grapl_filename, 'r').read())
id_expr, expr, isident = algs.idfixing(G, {'X'}, {'Y'})
assert not G.isdag()
assert G.isayclic()
...
grapl_filename = 'complex_dag.grapl'
G = grapl_obj.readgrapl(open(grapl_filename, 'r').read())
